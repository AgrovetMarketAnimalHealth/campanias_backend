  ...
  <style>
    * {
    ...
    .t-tipo-wrap {
      background: #EDD9FA;
      text-align: center;
      border-bottom: 0.3px solid #C9A0E8;
      border-top: 0.3px solid #C9A0E8;
      padding: 1mm 0;
      line-height: 1;
    }
    ...
    .talon-body {
      padding: 1.8mm 1.5mm 1mm;
    }

    .t-campo {
      margin-bottom: 1.5mm;
      padding-bottom: 1.2mm;
      border-bottom: 0.3px solid #EAE0FA;
    }
    ...
    .t-footer {
      border-top: 2.5px dashed #C9A0E8;
      margin-top: 1.2mm;
      padding: 1.5mm 0 1.8mm;
      background: #F5EEFF;
      text-align: center;
    }
